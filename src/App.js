  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged((authUser) => {
      if(authUser){
        ...
        return () => {
          // perform cleanup before useEffect refire
          unsubscribe();
        }
  }, [user, username]);

  // useEffect runs code based on a condition; i.e. a page refresh.. [] means run only once onLoad of App component
  // [posts] = run once and everytime posts changes
  useEffect(() => {
